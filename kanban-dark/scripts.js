document.addEventListener('DOMContentLoaded', function () {
    ...
    addItemForm.addEventListener('submit', function (e) {
      ...
      targetColumn.appendChild(newItem);
        ...
        // Wait for the animation to complete and reset the form
      setTimeout(function () {
        addItemForm.reset();
        addItemModal.hide();
      }, 750); // 750ms is the default duration for the 'bounceIn' animation
  ...
  function createNewItem(title, description) {
    ...
    deleteButton.addEventListener('click', function () {
      ...
      // Wait for the animation to complete and remove the item
      setTimeout(function () {
        item.remove();
      }, 750); // 750ms is the default duration for the 'bounceOut' animation
  
      // Wait for the shocking animation to complete and reset the form
      setTimeout(function () {
        addItemForm.reset();
        addItemModal.hide();
      }, 1000); // 1000ms is the default duration for the 'jello' animation
    });
    ...
    item.classList.add('animate__animated', 'animate__jello');
